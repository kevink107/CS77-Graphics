...
// Used the below variables for the advanced lighting effect
uniform float iTime;
...
void main()												
{
	...
	vtx_color=vec4(v_color.rgb,1.f); // vtx_color without advanced lighting effect

	////TODO: add your operations on the out varialbes
	vtx_nml = vec3(normal.xyz);
