...
public:
	...
	virtual void Initialize_Data()
	{
		...
		//// jukebox mesh
		// {
		// 	int obj_idx=Add_Obj_Mesh_Object("jukebox.obj");
		// 	auto obj=mesh_object_array[obj_idx];
		// 	Update_Vertex_Color_And_Normal_For_Mesh_Object(obj);		
		// }
		...
		std::string vertex_shader_file_name="normal_mapping.vert";		
		std::string fragment_shader_file_name="normal_mapping.frag";
		...
		// texture for dartmouth bunny
		//OpenGLTextureLibrary::Instance()->Add_Texture_From_File("dartmouth.jpg", "albedo");
		//OpenGLTextureLibrary::Instance()->Add_Texture_From_File("earth_normal.png", "normal");

		// texture for jukebox
		//OpenGLTextureLibrary::Instance()->Add_Texture_From_File("jukebox.jpg", "albedo");
		//OpenGLTextureLibrary::Instance()->Add_Texture_From_File("wood.jpg", "normal");
